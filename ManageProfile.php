					...
					<form action="PHP/ManageVolunteerProfile.php" method="Post" onsubmit="return Volunteer_Validate()">
						...
						<div class="button form-row">
							<div class="col-xl-4 col-md-6 offset-xl-2">
								<input type="submit" class="btn btn-block"  name="submit" value="Save Change">
							</div>
							<div class="col-xl-4 col-md-6">
								<input type="reset" class="btn btn-block" name="reset" value="Reset">
							</div>
						</div>
					</form>
				</div>
				<div class="back row">
					<input type="button" class="btn btn-block col-4 offset-md-4" name="backToManager" value="Back To Manager Page" onclick="document.location='CRSManagerPage.html'">
				</div>
			</div>
		</div>
