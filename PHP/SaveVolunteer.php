...
if(!$result){
	...
	$CreateVolunteerTableQuery = "CREATE TABLE Volunteer(VolunteerID integer(10) AUTO_INCREMENT PRIMARY KEY,username VARCHAR(255) NOT NULL,foreign key(username) references User(username))";
...
if(!$result){
	...
	$AddVolunteerQuery = "INSERT INTO Volunteer values(NULL,'$UserName')";
